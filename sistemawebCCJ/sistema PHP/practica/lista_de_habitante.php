...
<html lang="en">
    <head>
        ...
        <title>Lista de Habitantes</title>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                          <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de Habitantes</li>
                        </ol>
                    ...
                    <div class="table-responsive">        
                        ...
                        <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['codigo_telefono']; ?></td>
                                        ...
                                        <a href="editar_habitante.php?id=<?php echo $row['id_habitantes']?>" class="btn btn-secondary">
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_habitante.php" class="btn btn-success"> Registrar nuevo habitante</a>
                        </div>
                    </div>
                </div>
        </div>  
