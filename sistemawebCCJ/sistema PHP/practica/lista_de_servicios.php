                    ...
                    <div class="table-responsive">        
                        ...
                        <thead>
                                    ...
                                    <tr>
                                        ...
                                        <a href="editar_servicios.php?id=<?php echo $row['id_servicio']?>" class="btn btn-secondary">
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_servicios.php" class="btn btn-success"> Registrar nuevo servicio</a>
                        </div>
                    </div>
                </div>
        </div>  
