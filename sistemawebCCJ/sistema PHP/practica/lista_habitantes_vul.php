...
<html lang="en">
    <head>
        ...
        <title>Lista de vulnerados</title>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                         <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de Habitantes con vulnerabilidad</li>
                        </ol>
    ...
    $sql = $conexion->query("SELECT * FROM habitantes_vul 
    INNER JOIN habitantes ON habitantes_vul.id_habitantes = habitantes.id_habitantes
    INNER JOIN vulnerabilidad  ON habitantes_vul.id_vulnerabilidad = vulnerabilidad.id_vulnerabilidad
    ");
    ...
    <tr>
      ...
      <td scope="row"><?php echo $resultado ['nacionalidad']?></td>

      <td scope="row"><?php echo $resultado ['cedula']?></td>
      <td scope="row"><?php echo $resultado ['vulnerabilidad']?></td>
      <td scope="row"><?php echo $resultado ['observaciones']?></td>
      ...
      <a href="editar_habitantes_vul.php?id=<?php echo $resultado['id_h_to_v']?>" class="btn btn-secondary">
    ...
    ?>
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_habitantes_vul.php" class="btn btn-success"> Registrar nuevo habitante con Vulnerabilidad</a>
                        </div>
                    </div>
                </div>
        </div>  
