...
<html lang="en">
    ...
    <tr>
      ...
      <td scope="row"><?php echo $resultado ['nombre_usuario']?></td>
      <td scope="row"><?php echo $resultado ['clave']?></td>
      ...
      <td scope="row"><?php echo $resultado ['observacion']?></td>
      <td>
        
      <div class="text-center">
      <a href="edit_usuario.php?id=<?php echo $resultado['id_usuario']?>" class="btn btn-secondary">
    ...
    ?>
                       ...
                       <div class="text-center">
                            ...
                            <a href="principal.php" class="btn btn-success"> Registrar nuevo usuario</a>
                        </div>
                    </div>
                </div>
        </div>  
