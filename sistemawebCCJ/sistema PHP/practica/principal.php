<?php
    ...
    $resultado->execute();
    $dias = $resultado -> fetchAll (PDO :: FETCH_ASSOC);



    $consult = "SELECT * FROM status ";
    $resultad = $conexion ->prepare($consult);
    $resultad->execute();
    $dia = $resultad -> fetchAll (PDO :: FETCH_ASSOC);
?>
...
<html lang="en">
  ...
  <option value="inactivo">inactivo</option>
                        ...
                        <button type="submit" class=" btn btn-info btn-block">Registrar usuarios</button>
