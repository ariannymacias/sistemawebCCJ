                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                         <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar Beneficios</li>
                        </ol>
                        ...
                        <div class="card card-body container-fluid" style="max-width:390px;">
                            <form action="guardar_beneficio.php" method="POST">

                            <label for="">Beneficio</label>
                            <div class="form-group">
                                <input type="text" name="nombre_beneficio" class="form-control" placeholder="nombre_beneficio" autofocus required>
                            </div>
    ...
    <option value="activo">activo</option>
        <option value="inactivo">inactivo</option>
                        ...
                        <br>
                            ...
                            <input type="submit" name="guardar_beneficio" class="btn btn-info btn-block" value="Registrar Beneficio" >
                            </form>
                            <br>
