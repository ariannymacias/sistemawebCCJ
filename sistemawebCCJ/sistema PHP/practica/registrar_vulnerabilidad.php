...
<html lang="en">
    <head>
        ...
        <title>Registrar Vulnerabilidad</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar Vulnerabilidad</li>
                        </ol>
                        ...
                        <div class="card card-body container-fluid" style="max-width:390px;">
                            ...
                            <div class="form-group">
                                <input type="text" name="vulnerabilidad" class="form-control" placeholder="vulnerabilidad" autofocus required>
                            </div>
    ...
    <option value="activo">activo</option>
        <option value="inactivo">inactivo</option>
                        ...
                        <br>
                            <hr>
                            <input type="submit" name="guardar_vulnerabilidad" class="btn btn-info btn-block" value="Registrar Vulnerabilidad">
