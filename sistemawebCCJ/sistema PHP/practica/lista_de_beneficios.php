                    ...
                    <div class="table-responsive">        
                        ...
                        <thead>
                                    ...
                                    <tr>
                                        ...
                                        <a href="editar_beneficios.php?id=<?php echo $row['id_beneficios']?>" class="btn btn-secondary">
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_beneficios.php" class="btn btn-success"> Registrar nuevo beneficios</a>
                        </div>
                    </div>
                </div>
        </div>  
