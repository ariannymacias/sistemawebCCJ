...
<html lang="en">
    <head>
        ...
        <title>Habitantes con beneficios</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar habitantes con beneficios</li>
                        </ol>



                        <div class="card card-body container-fluid" style="max-width:390px;">
                        <form action="guardar_habitantes_beneficios.php" method="POST">
  
                        <label for="">Nombre de Habitante</label>
  <select class="form-select mb-3" name="id_habitante" required>
  <option selected disable>--seleccionar id--</option required>

  <?php 
  
  include("Conexiones.php");

  $sql = $conexion->query("SELECT * FROM habitantes");
  while ($resultado = $sql->fetch_assoc()) {
    echo "<option value=".$resultado['id_habitantes']."> ".$resultado['id_habitantes']."
   ".$resultado['primer_nombre']." ".$resultado['cedula']."</option>";
  }
...
<label for="">Nombre de Habitante</label>
  <select class="form-select mb-3" name="id_usuario" required>
  
  <option selected disable>--seleccionar usuario --</option required>
  ...
  while ($resultado = $sql->fetch_assoc()) {
    echo "<option value=".$resultado['id_usuario']."> ".$resultado['id_usuario'] ." "
    .$resultado['nombre_usuario']." </option>";
  }
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea name="observacio" id="" cols="15" rows="10" class="form-control" placeholder="observacion (opcional)" autofocus></textarea>
                        ...
                        <button type="submit" class=" btn btn-info btn-block">Registrar habitantes con beneficios</button>
