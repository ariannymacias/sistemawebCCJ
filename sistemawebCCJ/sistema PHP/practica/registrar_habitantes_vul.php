...
<html lang="en">
            ...
            <ul class="navbar-nav ms-auto ms-auto me-0 me-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="recuperar2">Cambiar Clave</a></li>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar vulnerados</li>
                        </ol>
  ...
  <select class="form-select mb-3" name="id_habitantes" required>
...
<label for="">Tipo de vulnerabilidad</label>
  ...
  <option selected disable>--seleccionar id vulnerabilidad--</option required>
  ...
  <div class="form-group">
    ...
    <textarea name="observaciones" id="observaciones" cols="15" rows="10" class="form-control" placeholder="observacion (opcional)" autofocus></textarea>
                        ...
                        <button type="submit" class=" btn btn-info btn-block">Registrar habitantes con vulnerabilidad</button>
