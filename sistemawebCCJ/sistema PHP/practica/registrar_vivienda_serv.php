            ...
            <ul class="navbar-nav ms-auto ms-auto me-0 me-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="recuperar.php">Cambiar Clave</a></li>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar Servicio de Vivienda</li>
                        </ol>
                        ...
                        <form action="guardar_vivienda_serv.php" method="POST">
...
<label for="">Observacion</label>
  ...
  <div class="form-group">
    ...
    <textarea name="comentario" id="comentario" cols="15" rows="10" class="form-control" placeholder="observacion (opcional)" autofocus></textarea>
                        ...
                        <button type="submit" class=" btn btn-info btn-block">Registrar servicio en vivienda</button>
