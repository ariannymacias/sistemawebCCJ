...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2023 a las 23:31:55
...
INSERT INTO `beneficios` (`id_beneficios`, `nombre_beneficio`, `status`, `observacion`) VALUES
(1, 'Juguetes', 'activo', ''),
(2, 'bolsa CLAP', 'activo', ''),
(3, 'bolsa de nutricion ', 'activo', ''),
(4, 'combo de proteinas', 'activo', ''),
(5, 'combo de hortalizas', 'activo', '');
...
CREATE TABLE `bonos` (
  ...
  `status` enum('activo','inactivo') NOT NULL,
  `observacion_bono` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `bonos` (`id_bono`, `bono`, `status`, `observacion_bono`) VALUES
(1, 'Jose Gregorio', 'activo', ''),
(3, 'hogar de la patria', 'activo', ''),
(4, 'parto humanizado', 'activo', ''),
(5, 'lactancia materna', 'activo', ''),
(6, '100% escolaridad ', 'activo', ''),
(7, 'economia familiar ', 'activo', ''),
(8, 'bono guerra', 'activo', ''),
(10, 'maternidad', 'activo', '');
...
CREATE TABLE `habitantes` (
  ...
  `nacionalidad` enum('V','E','J') NOT NULL,
  `cedula` int(9) NOT NULL,
  `fecha_nacimiento` date NOT NULL,
  `sexo` enum('M','F') NOT NULL,
  `correo` varchar(60) NOT NULL,
  `codigo_telefono` enum('0424','0414','0412','0426','0416','0251') NOT NULL,
...
INSERT INTO `habitantes` (`id_habitantes`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `nacionalidad`, `cedula`, `fecha_nacimiento`, `sexo`, `correo`, `codigo_telefono`, `telefono`, `observacion`) VALUES
(1, 'Arianny', 'Daniela', 'Macias', 'Chinchilla', 'V', 29916943, '2002-11-14', 'F', 'maciaschinchilla@gmail.com', '0416', '2558778', 'Prueba');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `habitantes_to_beneficios`
--

CREATE TABLE `habitantes_to_beneficios` (
  `id_h_to_v` int(11) NOT NULL,
  `id_habitante` int(11) NOT NULL,
  `id_beneficio` int(11) NOT NULL,
  `id_vivienda` int(11) NOT NULL,
  `status` enum('activo','inactivo','','') NOT NULL,
  `fecha_entrega` date NOT NULL,
  `observacio` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `habitantes_to_bonos`
--

CREATE TABLE `habitantes_to_bonos` (
  `id_h_to_b` int(11) NOT NULL,
  `id_habitante` int(11) NOT NULL,
  `id_bono` int(11) NOT NULL,
  `status` enum('activo','inactivo','','') NOT NULL,
  `obse` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `habitantes_to_sistema_patria`
--

CREATE TABLE `habitantes_to_sistema_patria` (
  `id_h_to_sp` int(11) NOT NULL,
  `cedula` int(8) NOT NULL,
  `carnets` enum('posee','no posee','','') NOT NULL,
  `codigo` varchar(80) NOT NULL,
  `serial` varchar(80) NOT NULL,
  `status` enum('activo','inactivo','','') NOT NULL,
  `observ` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `habitantes_to_sistema_patrias`
--

CREATE TABLE `habitantes_to_sistema_patrias` (
  `id_h_to_sp` int(11) NOT NULL,
  `id_habitantes` int(8) NOT NULL,
  `codigo` varchar(20) NOT NULL,
  `serial` varchar(20) NOT NULL,
  `observ` longtext NOT NULL,
  `carnets` varchar(80) NOT NULL,
  `status` varchar(80) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `habitantes_to_sistema_patrias`
--

INSERT INTO `habitantes_to_sistema_patrias` (`id_h_to_sp`, `id_habitantes`, `codigo`, `serial`, `observ`, `carnets`, `status`) VALUES
(1, 1, '12345', '12345', 'Practica', 'posee', 'activo');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `habitantes_to_vulnerabilidad`
--

CREATE TABLE `habitantes_to_vulnerabilidad` (
  `id_h_to_v` int(11) NOT NULL,
  `id_habitante` int(11) NOT NULL,
  `id_vulnerabilidad` int(80) NOT NULL,
...
--
-- Estructura de tabla para la tabla `habitantes_vul`
--

CREATE TABLE `habitantes_vul` (
  `id_h_to_v` int(11) NOT NULL,
  `id_habitantes` int(40) NOT NULL,
  `id_vulnerabilidad` int(33) NOT NULL,
  `observaciones` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `servicios` (`id_servicio`, `servicios`, `status`, `observacion`) VALUES
(1, 'electricidad', 'activo', ''),
(2, 'gas', 'activo', ''),
(3, 'agua', 'activo', ''),
(4, 'internet', 'activo', ''),
(10, 'Mas de un servicio', 'activo', ''),
(11, 'Ningun servicio', 'activo', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `servicio_to_vivienda`
--

CREATE TABLE `servicio_to_vivienda` (
  `id_s_to_v` int(11) NOT NULL,
  `id_vivienda` int(80) NOT NULL,
  `id_servicio` int(11) NOT NULL,
  `status` enum('activo','inactivo','','') NOT NULL,
...
--
-- Volcado de datos para la tabla `servicio_to_vivienda`
--

INSERT INTO `servicio_to_vivienda` (`id_s_to_v`, `id_vivienda`, `id_servicio`, `status`, `comentario`) VALUES
(1, 1, 2, 'activo', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `servicio_to_viviendas`
--

CREATE TABLE `servicio_to_viviendas` (
  `id_s_to_v` int(11) NOT NULL,
  `id_vivienda` int(40) NOT NULL,
  `id_servicio` int(33) NOT NULL,
  `comentario` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Estructura de tabla para la tabla `sistema_patria`
--

CREATE TABLE `sistema_patria` (
  `id_patria` int(11) NOT NULL,
  `id_posee_carnet` varchar(50) NOT NULL,
  `codigo` varchar(33) NOT NULL,
  `serial` varchar(33) NOT NULL,
  `observacion` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `sistema_patria`
--

INSERT INTO `sistema_patria` (`id_patria`, `id_posee_carnet`, `codigo`, `serial`, `observacion`) VALUES
(3, 'no posee', '0000000000', '0000000000', ''),
(5, 'si posee', '0000584336', '0000633184', '');
...
CREATE TABLE `status` (
  ...
  `nombre_statu` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `status` (`id_status`, `nombre_statu`) VALUES
(1, 'activo'),
(2, 'inactivo'),
(5, '');
...
INSERT INTO `usuarios` (`id_usuario`, `nombre_usuario`, `clave`, `email`, `id_nivel`, `status`, `observacion`) VALUES
(1, 'Henry', '21232f297a57a5a743894a0e4a801fc3', 'escalonah12@gmail.com', 1, 'activo', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usur`
--
...
CREATE TABLE `usur` (
  ...
  `id_nivel` enum('jefa','manzanera','habitante','') NOT NULL,
  `creado` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `usur`
--

INSERT INTO `usur` (`id_usuario`, `Nombre_usuario`, `cedula`, `clave`, `id_status`, `id_nivel`, `creado`) VALUES
(5, 'yura', 123, '123', 'activo', 'jefa', '2023-06-19 22:32:20'),
(6, 'henry', 0, 'ddd', 'activo', 'jefa', '2023-06-19 22:33:31');
...
CREATE TABLE `vivienda` (
  ...
  `color_casa` varchar(21) NOT NULL,
...
INSERT INTO `vivienda` (`id_vivienda`, `numero_casa`, `ubicacion`, `color_casa`, `habitaciones`, `baños`, `observacion`) VALUES
(1, 23, 'Japon 2', 'Azul', 3, 1, 'Practica');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vulnerabili`
--

CREATE TABLE `vulnerabili` (
  `id_vulnerabilidad` int(11) NOT NULL,
  `vulnerabilidad` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `observacion` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `vulnerabili`
--

INSERT INTO `vulnerabili` (`id_vulnerabilidad`, `vulnerabilidad`, `observacion`) VALUES
(1, 'desnutricion', ''),
(2, 'sobre peso', ''),
...
CREATE TABLE `vulnerabilidad` (
  `id_vulnerabilidad` int(11) NOT NULL,
  `vulnerabilidad` varchar(80) NOT NULL,
  `status` enum('activo','inactivo','','') NOT NULL,
  `observacion` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `vulnerabilidad` (`id_vulnerabilidad`, `vulnerabilidad`, `status`, `observacion`) VALUES
(1, 'desnutricion', 'activo', ''),
(2, 'sobrepeso', 'activo', ''),
(3, 'mujeres embarazadas', 'activo', '');
...
--
-- Indices de la tabla `habitantes_to_beneficios`
--
ALTER TABLE `habitantes_to_beneficios`
  ADD PRIMARY KEY (`id_h_to_v`),
  ADD KEY `id_habitante` (`id_habitante`),
  ADD KEY `id_vivienda` (`id_vivienda`),
  ADD KEY `id_beneficio` (`id_beneficio`);

--
-- Indices de la tabla `habitantes_to_bonos`
--
ALTER TABLE `habitantes_to_bonos`
  ADD PRIMARY KEY (`id_h_to_b`),
  ADD KEY `id_habitante` (`id_habitante`),
  ADD KEY `id_bono` (`id_bono`);

--
-- Indices de la tabla `habitantes_to_sistema_patria`
--
ALTER TABLE `habitantes_to_sistema_patria`
  ADD PRIMARY KEY (`id_h_to_sp`),
  ADD UNIQUE KEY `cedula` (`cedula`);

--
-- Indices de la tabla `habitantes_to_sistema_patrias`
--
ALTER TABLE `habitantes_to_sistema_patrias`
  ADD PRIMARY KEY (`id_h_to_sp`),
...
--
-- Indices de la tabla `habitantes_to_vulnerabilidad`
--
ALTER TABLE `habitantes_to_vulnerabilidad`
  ADD PRIMARY KEY (`id_h_to_v`),
  ADD KEY `id_habitante` (`id_habitante`),
  ADD KEY `id_vulnerabilidad` (`id_vulnerabilidad`);

--
-- Indices de la tabla `habitantes_vul`
--
ALTER TABLE `habitantes_vul`
  ADD PRIMARY KEY (`id_h_to_v`),
  ADD KEY `id_habitantes` (`id_habitantes`),
  ADD KEY `id_vulnerabilidad` (`id_vulnerabilidad`);
...
--
-- Indices de la tabla `servicio_to_vivienda`
--
ALTER TABLE `servicio_to_vivienda`
  ADD PRIMARY KEY (`id_s_to_v`),
  ADD UNIQUE KEY `id_servicio` (`id_servicio`),
  ADD KEY `id_vivienda` (`id_vivienda`);

--
-- Indices de la tabla `servicio_to_viviendas`
--
ALTER TABLE `servicio_to_viviendas`
  ADD PRIMARY KEY (`id_s_to_v`),
  ADD KEY `id_vivienda` (`id_vivienda`),
  ADD KEY `id_servicio` (`id_servicio`);

--
-- Indices de la tabla `sistema_patria`
--
ALTER TABLE `sistema_patria`
  ADD PRIMARY KEY (`id_patria`);
...
--
-- Indices de la tabla `vulnerabili`
--
ALTER TABLE `vulnerabili`
  ADD PRIMARY KEY (`id_vulnerabilidad`);
...
--
ALTER TABLE `beneficios`
  MODIFY `id_beneficios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `bonos`
--
ALTER TABLE `bonos`
  MODIFY `id_bono` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT de la tabla `habitantes_to_beneficios`
--
ALTER TABLE `habitantes_to_beneficios`
  MODIFY `id_h_to_v` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_bonos`
--
ALTER TABLE `habitantes_to_bonos`
  MODIFY `id_h_to_b` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_sistema_patria`
--
ALTER TABLE `habitantes_to_sistema_patria`
  MODIFY `id_h_to_sp` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_sistema_patrias`
--
ALTER TABLE `habitantes_to_sistema_patrias`
  MODIFY `id_h_to_sp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_vulnerabilidad`
--
ALTER TABLE `habitantes_to_vulnerabilidad`
  MODIFY `id_h_to_v` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `habitantes_vul`
--
ALTER TABLE `habitantes_vul`
  MODIFY `id_h_to_v` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `servicio_to_vivienda`
--
ALTER TABLE `servicio_to_vivienda`
  MODIFY `id_s_to_v` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `servicio_to_viviendas`
--
ALTER TABLE `servicio_to_viviendas`
  MODIFY `id_s_to_v` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `sistema_patria`
--
ALTER TABLE `sistema_patria`
  MODIFY `id_patria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT de la tabla `usur`
--
ALTER TABLE `usur`
...
--
-- AUTO_INCREMENT de la tabla `vulnerabili`
--
ALTER TABLE `vulnerabili`
  MODIFY `id_vulnerabilidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `vulnerabilidad`
--
ALTER TABLE `vulnerabilidad`
  MODIFY `id_vulnerabilidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Filtros para la tabla `habitantes_to_beneficios`
--
ALTER TABLE `habitantes_to_beneficios`
  ADD CONSTRAINT `id_beneficio` FOREIGN KEY (`id_beneficio`) REFERENCES `beneficios` (`id_beneficios`),
  ADD CONSTRAINT `id_habitante` FOREIGN KEY (`id_habitante`) REFERENCES `habitantes` (`id_habitantes`),
  ADD CONSTRAINT `id_vivienda` FOREIGN KEY (`id_vivienda`) REFERENCES `vivienda` (`id_vivienda`);

--
-- Filtros para la tabla `habitantes_to_bonos`
--
ALTER TABLE `habitantes_to_bonos`
  ADD CONSTRAINT `habitantes_to_bonos_ibfk_1` FOREIGN KEY (`id_habitante`) REFERENCES `habitantes` (`id_habitantes`),
  ADD CONSTRAINT `habitantes_to_bonos_ibfk_2` FOREIGN KEY (`id_bono`) REFERENCES `bonos` (`id_bono`);

--
-- Filtros para la tabla `habitantes_to_sistema_patrias`
--
ALTER TABLE `habitantes_to_sistema_patrias`
  ADD CONSTRAINT `habitantes_to_sistema_patrias_ibfk_1` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`);

--
-- Filtros para la tabla `habitantes_to_vulnerabilidad`
--
ALTER TABLE `habitantes_to_vulnerabilidad`
  ADD CONSTRAINT `habitantes_to_vulnerabilidad_ibfk_1` FOREIGN KEY (`id_habitante`) REFERENCES `habitantes` (`id_habitantes`);

--
-- Filtros para la tabla `habitantes_vul`
--
ALTER TABLE `habitantes_vul`
  ADD CONSTRAINT `habitantes_vul_ibfk_1` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `habitantes_vul_ibfk_2` FOREIGN KEY (`id_vulnerabilidad`) REFERENCES `vulnerabilidad` (`id_vulnerabilidad`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Filtros para la tabla `servicio_to_vivienda`
--
ALTER TABLE `servicio_to_vivienda`
  ADD CONSTRAINT `servicio_to_vivienda_ibfk_2` FOREIGN KEY (`id_servicio`) REFERENCES `servicios` (`id_servicio`);

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`id_nivel`) REFERENCES `niveles` (`id_nivel`);
COMMIT;
