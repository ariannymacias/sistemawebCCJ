                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                           <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar habitantes con beneficio de bonos</li>
                        </ol>



                        <div class="card card-body container-fluid" style="max-width:390px;">
                        <form action="guardar_habitantes_bonos.php" method="POST">
  
                        <label for="">Habitante</label>
...
<label for="">Bono</label>
  ...
  <label for="">Observacion </label>
    <textarea name="obse" id="obse" cols="15" rows="10" class="form-control" placeholder="observacion (opcional)" autofocus></textarea>
                        ...
                        <button type="submit" class=" btn btn-info btn-block">Registrar habitantes con bonos</button>
