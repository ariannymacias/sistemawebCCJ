...
<html lang="en">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Sistema patria</li>
                        </ol>



                        <div class="card card-body container-fluid" style="max-width:390px;">
                        <form action="guardar_patria.php" method="POST">
  ...
  while ($resultado = $sql->fetch_assoc()) {
    echo "<option value=".$resultado['id_habitantes'].">
...
<label for="">Observacion</label>
  <div class="form-group">
    ...
    <textarea name="observ" id="" cols="15" rows="10" class="form-control" placeholder="observacion (opcional)" autofocus></textarea>
                        ...
                        <button type="submit" class=" btn btn-info btn-block">Registrar habitante con carnet</button>
