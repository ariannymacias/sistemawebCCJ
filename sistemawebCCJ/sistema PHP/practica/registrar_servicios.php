                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card card-body container-fluid" style="max-width:390px;">
                            ...
                            <div class="form-group">
                                <input type="text" name="servicios" class="form-control" placeholder="servicios" autofocus required>
                            </div>
    ...
    <option value="activo">activo</option>
        <option value="inactivo">inactivo</option>
                        ...
                        <br>
                            ...
                            <input type="submit" name="guardar_servicios" class="btn btn-info btn-block" value="Registrar Servicios">
                            </form>
<br>
