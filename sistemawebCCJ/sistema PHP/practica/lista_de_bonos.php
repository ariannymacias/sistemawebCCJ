                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                           <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de Bonos</li>
                        </ol>
                    ...
                    <div class="table-responsive">        
                        ...
                        <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['observacion_bono']; ?></td>
                                        
                                        <td>
                                        <div class="text-center">
                                        <a href="editar_bonos.php?id=<?php echo $row['id_bono']?>" class="btn btn-secondary">
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_bonos.php" class="btn btn-success"> Registrar nuevo bono</a>
                        </div>
                    </div>
                </div>
        </div>  
