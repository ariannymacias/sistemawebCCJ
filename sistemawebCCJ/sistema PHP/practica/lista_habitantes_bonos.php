...
<html lang="en">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                         <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de Habitantes con Bonos</li>
                        </ol>
    ...
    $sql = $conexion->query("SELECT * FROM habitantes_to_bonos 
    INNER JOIN habitantes ON habitantes_to_bonos.id_habitante = habitantes.id_habitantes
    INNER JOIN bonos ON habitantes_to_bonos.id_bono = bonos.id_bono
    ");
    ...
    <tr>
      ...
      <td scope="row"><?php echo $resultado ['bono']?></td>
      
      <td scope="row"><?php echo $resultado ['status']?></td>
      
      <td scope="row"><?php echo $resultado ['obse']?></td>
      <td> 
      <div class="text-center">  
      <a href="editar_habitantes_bonos.php?id=<?php echo $resultado['id_h_to_b']?>" class="btn btn-secondary">
    ...
    ?>
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_habitantes_bonos.php" class="btn btn-success"> Registrar nuevo habitante con bono</a>
                        </div>
                    </div>
                </div>
        </div>  
