...
<html lang="en">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                           <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de Registrados en patria</li>
                        </ol>
    ...
    $sql = $conexion->query("SELECT * FROM habitantes_to_sistema_patrias 
    INNER JOIN habitantes ON habitantes_to_sistema_patrias.id_habitantes = habitantes.id_habitantes
    ");
    ...
    <tr>
      ...
      <td scope="row"><?php echo $resultado ['carnets']?></td>
      <td scope="row"><?php echo $resultado ['codigo']?></td>
      <td scope="row"><?php echo $resultado ['serial']?></td>
      <td scope="row"><?php echo $resultado ['status']?></td>
      <td scope="row"><?php echo $resultado ['observ']?></td>
      <td> 
      <div class="text-center">  
      <a href="editar_patria.php?id=<?php echo $resultado['id_h_to_sp']?>" class="btn btn-secondary">
    ...
    ?>  
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_patria.php" class="btn btn-success"> Registrar nuevo usuario con carnet</a>
                                </div>
                    </div>
                </div>
        </div>  
