...
<html lang="en">
    <head>
        ...
        <title>Lista de vulnerabilidad</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de Vulnerabilidad</li>
                        </ol>
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <thead>
                                    ...
                                    <?php
                                    $query = "SELECT * FROM vulnerabilidad";
                                    ...
                                    <tr>
                                        ...
                                        <a href="editar_vulnerabilidad.php?id=<?php echo $row['id_vulnerabilidad']?>" class="btn btn-secondary">
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_vulnerabilidad.php" class="btn btn-success"> Registrar nueva vulnerabilidad</a>
                        </div>                 
                    </div>
                </div>
        </div>  
