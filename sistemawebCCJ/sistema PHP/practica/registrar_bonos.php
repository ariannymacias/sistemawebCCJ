                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                         <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar Bonos</li>
                        </ol>
                        ...
                        <div class="card card-body container-fluid" style="max-width:390px;">
                            <form action="guardar_bono.php" method="POST">

                            <label for="">Bono</label>
                            <div class="form-group">
                                <input type="text" name="bono" class="form-control" placeholder="bono" autofocus required>
                            </div>
    ...
    <option value="activo">activo</option>
        <option value="inactivo">inactivo</option>
                        ...
                        <br>
                            ...
                            <input type="submit" name="guardar_bono" class="btn btn-info btn-block" value="Registrar Bono" >
                            </form>
                            <br>
