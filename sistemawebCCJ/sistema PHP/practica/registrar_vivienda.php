                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Registrar Vivienda</li>
                        </ol>
                        ...
                        <div class="card card-body container-fluid" style="max-width:390px;">
                                    <form action="guardar_vivienda.php" method="POST">
                                    
                                    <label for="">N° de Casa</label>
                                    <div class="form-group">

                                        <input type="number" name="numero_casa" class="form-control" placeholder="numero_casa" autofocus >
                                    </div>
                                        <br>
                                ...
                                <textarea name="observacion" id="" cols="30" rows="10" class="form-control" placeholder="observacion" autofocus></textarea>
                                    ...
                                    <input type="submit" name="guardar_vivienda" class="btn btn-info btn-block" value="Registrar Vivienda">
