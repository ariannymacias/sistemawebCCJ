...
<html lang="en">
    <head>
        ...
        <title>Lista viviendas con servicios</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de viviendas con servicios</li>
                        </ol>
    ...
    $sql = $conexion->query("SELECT * FROM servicio_to_vivienda 
    INNER JOIN vivienda ON servicio_to_vivienda.id_vivienda  = vivienda.id_vivienda
    INNER JOIN servicios  ON servicio_to_vivienda.id_servicio = servicios.id_servicio
    ");
    ...
    <tr>
      ...
      <td scope="row"><?php echo $resultado ['servicios']?></td>
      <td scope="row"><?php echo $resultado ['status']?></td>
      <td scope="row"><?php echo $resultado ['comentario']?></td>
      ...
      <div class="text-center">
        <a href="editar_servicios_vivienda.php?id=<?php echo $resultado['id_s_to_v']?>" class="btn btn-secondary">
    ...
    ?>
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_vivienda_serv.php" class="btn btn-success"> Registrar servicio en vivienda</a>
                        </div>
                    </div>
                </div>
        </div>  
