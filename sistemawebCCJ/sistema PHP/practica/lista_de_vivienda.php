                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Comunidad Japon II <i class="bi bi-brightness-alt-high-fill"></i></h1>
                          <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Lista de Vivienda</li>
                        </ol>
                    ...
                    <div class="table-responsive">        
                        ...
                        <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['color_casa']; ?></td>
                                        <td><?php echo $row['habitaciones']; ?></td>
                                        <td><?php echo $row['baños']; ?></td>
                                        <td><?php echo $row['observacion']; ?></td>
                                        
                                        <td>
                                        <div class="text-center">
                                        <a href="editar_vivienda.php?id=<?php echo $row['id_vivienda']?>" class="btn btn-secondary">
                       ...
                       <div class="text-center">
                            ...
                            <a href="registrar_vivienda.php" class="btn btn-success"> Registrar nueva vivienda</a>
                        </div>
                    </div>
                </div>
        </div>  
