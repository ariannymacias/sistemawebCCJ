...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2023 a las 06:19:22
...
INSERT INTO `bonos` (`id_bono`, `bono`, `status`, `observacion`) VALUES
...
--
-- Estructura de tabla para la tabla `sistema patria`
--

CREATE TABLE `sistema patria` (
...
--
-- Volcado de datos para la tabla `sistema patria`
--

INSERT INTO `sistema patria` (`id_patria`, `id_posee_carnet`, `codigo`, `serial`, `observacion`) VALUES
...
--
-- Estructura de tabla para la tabla `vulnerabiblidad`
--

CREATE TABLE `vulnerabiblidad` (
  `id_vulnerabilidad` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `vulnerabiblidad`
--

INSERT INTO `vulnerabiblidad` (`id_vulnerabilidad`, `vulnerabilidad`, `observacion`, `status`) VALUES
(1, 'desnutrición ', '', 'activo'),
(2, 'sobre peso', '', 'activo'),
...
ALTER TABLE `habitantes_to_sistema_patria`
  ...
  ADD KEY `id_habitante` (`id_habitante`),
  ADD KEY `id_posee_carnet` (`id_posee_carnet`);
...
--
-- Indices de la tabla `sistema patria`
--
ALTER TABLE `sistema patria`
  ADD PRIMARY KEY (`id_patria`),
  ADD KEY `id_posee_carnet_2` (`id_posee_carnet`);
...
--
-- Indices de la tabla `vulnerabiblidad`
--
ALTER TABLE `vulnerabiblidad`
...
--
ALTER TABLE `beneficios`
  MODIFY `id_beneficios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `bonos`
--
ALTER TABLE `bonos`
  MODIFY `id_bono` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de la tabla `sistema patria`
--
ALTER TABLE `sistema patria`
  MODIFY `id_patria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `vulnerabiblidad`
--
ALTER TABLE `vulnerabiblidad`
...
--
ALTER TABLE `habitantes_to_beneficios`
  ADD CONSTRAINT `habitantes_to_beneficios_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
...
--
-- Filtros para la tabla `habitantes_to_sistema_patria`
--
ALTER TABLE `habitantes_to_sistema_patria`
  ADD CONSTRAINT `habitantes_to_sistema_patria_ibfk_1` FOREIGN KEY (`id_habitante`) REFERENCES `habitantes` (`id_habitantes`),
  ADD CONSTRAINT `habitantes_to_sistema_patria_ibfk_2` FOREIGN KEY (`id_posee_carnet`) REFERENCES `sistema patria` (`id_posee_carnet`);
...
ALTER TABLE `habitantes_to_vulnerabilidad`
  ...
  ADD CONSTRAINT `habitantes_to_vulnerabilidad_ibfk_2` FOREIGN KEY (`id_vulnerabilidad`) REFERENCES `vulnerabiblidad` (`id_vulnerabilidad`);
...
--
ALTER TABLE `servicio_to_vivienda`
  ADD CONSTRAINT `servicio_to_vivienda_ibfk_1` FOREIGN KEY (`id_vivienda`) REFERENCES `vivienda` (`id_vivienda`),
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `usuarios_ibfk_3` FOREIGN KEY (`id_status`) REFERENCES `status` (`id_status`);
COMMIT;
